//
//  BoardViewControllerTableVersion.swift
//  Boardster
//
...
class BoardViewControllerTableVersion: UITableViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func cancel(sender: UIBarButtonItem) {
        ...
        let isPresentingInAddBoardMode = presentingViewController is UINavigationController
        
        if isPresentingInAddBoardMode {
            dismissViewControllerAnimated(true, completion: nil)
        } else {
